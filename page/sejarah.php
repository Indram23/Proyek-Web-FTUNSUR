...
<div class ="container-fluid">
    <div class="row">
        ...
        <div class="btn-group btn-breadcrumb">
            ...
            <span class="btn btn-info btn1">Profil</span>
            <span class="btn btn-info btn1"><strong>Sejarah</strong></span>
         </div>
    ...
    <div class="row">
         <div class="col-sm-12">
            ...
            <li><i class="fas fa-check"> Sejarah</i></li>
            <li><a href="?page=sambutan"><i class="fa fa-times"> Sambutan</i>  </a></li>
        </ol>
         </div>
     </div>
     </div>
